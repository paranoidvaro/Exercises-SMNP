...
for i in n_rk:
	...
	print(f"Error for Runge-Kutta2 method at N = {i} is {computeError(rk.integrate(),solRefRK,r_rk):.7f}")
...
for i in n_e:
	...
	r_e = n_ref//i
	errE.append(computeError(e.integrate(),solRefE,r_e))
	print(f"Error for Explicit Euler method at N = {i} is {computeError(e.integrate(),solRefE,r_e):.7f}")
